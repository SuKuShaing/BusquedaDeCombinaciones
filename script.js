...
btnEncontrarCandidatos.addEventListener("click", () => {
    ...
    if (navigator.serviceWorker.controller) {
        ...
        messageChannel.port1.onmessage = event => {
            ...
            resultados.innerHTML += `Operaciones realizadas: ${colocarPuntos(operaciones)}<br>`;
            // cantidad de combinaciones encontradas
            resultados.innerHTML += `Cantidad de combinaciones encontradas: ${colocarPuntos(combinaciones.length)}<br><br>`;
